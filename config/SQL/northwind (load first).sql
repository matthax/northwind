...
DROP SCHEMA IF EXISTS `booxch5_NW` ;
CREATE SCHEMA IF NOT EXISTS `booxch5_NW` DEFAULT CHARACTER SET latin1 ;
USE `booxch5_NW` ;

-- -----------------------------------------------------
-- Table `booxch5_NW`.`customers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`customers` (
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`employees`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`employees` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`privileges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`privileges` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`employee_privileges`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`employee_privileges` (
  ...
  CONSTRAINT `fk_employee_privileges_employees1`
    ...
    REFERENCES `booxch5_NW`.`employees` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_employee_privileges_privileges1`
    FOREIGN KEY (`privilege_id`)
    REFERENCES `booxch5_NW`.`privileges` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`inventory_transaction_types`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`inventory_transaction_types` (
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`shippers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`shippers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`orders_tax_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`orders_tax_status` (
  `id` TINYINT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`orders_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`orders_status` (
  `id` TINYINT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_orders_customers`
    ...
    REFERENCES `booxch5_NW`.`customers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_orders_shippers1`
    ...
    REFERENCES `booxch5_NW`.`shippers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_tax_status1`
    FOREIGN KEY (`tax_status_id`)
    REFERENCES `booxch5_NW`.`orders_tax_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_orders_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `booxch5_NW`.`orders_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`products`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`products` (
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`purchase_order_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`purchase_order_status` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`suppliers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`suppliers` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `company` VARCHAR(50) NULL DEFAULT NULL,
  `last_name` VARCHAR(50) NULL DEFAULT NULL,
  `first_name` VARCHAR(50) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`purchase_orders`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`purchase_orders` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_orders_purchase_order_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `booxch5_NW`.`purchase_order_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_purchase_orders_suppliers1`
    FOREIGN KEY (`supplier_id`)
    REFERENCES `booxch5_NW`.`suppliers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`inventory_transactions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`inventory_transactions` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`invoices`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`invoices` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`order_details_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`order_details_status` (
  `id` INT(11) NOT NULL,
  `status_name` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`order_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_order_details_order_details_status1`
    FOREIGN KEY (`status_id`)
    REFERENCES `booxch5_NW`.`order_details_status` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`purchase_order_details`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`purchase_order_details` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_purchase_order_details_inventory_transactions1`
    ...
    REFERENCES `booxch5_NW`.`inventory_transactions` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`sales_reports`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`sales_reports` (
...
-- -----------------------------------------------------
-- Table `booxch5_NW`.`strings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `booxch5_NW`.`strings` (
